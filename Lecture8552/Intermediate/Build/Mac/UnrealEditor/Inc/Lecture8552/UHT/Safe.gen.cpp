...
void EmptyLinkFunctionForGeneratedCodeSafe() {}
...
#endif
#define UHT_STATICS Z_Construct_UClass_ASafe_Statics
struct UHT_STATICS
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Type_MetaData[] = {
		{ "IncludePath", "Interactable/Safe.h" },
		{ "ModuleRelativePath", "Public/Interactable/Safe.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_LootMesh_MetaData[] = {
		{ "Category", "Components" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Interactable/Safe.h" },
	};
...
// ********** End Class ASafe constinit property declarations **************************************
	...
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
		TCppClassTypeTraits<ASafe>::IsAbstract,
	};
...
const UECodeGen_Private::FImplementedInterfaceParams UHT_STATICS::InterfaceParams[] = {
	{ Z_Construct_UClass_UInteractable, (int32)VTABLE_OFFSET(ASafe, IInteractable), false },  // f9816440c440ea778c24dd0bbe90b5aab29ab03e
};
const UECodeGen_Private::FClassParams UHT_STATICS::ClassParams = {
	&Z_Construct_UClass_ASafe,
	"Engine",
...
FClassRegistrationInfo Z_Registration_Info_UClass_ASafe;
UClass* Z_Construct_UClass_ASafe(ETypeConstructPhase Phase)
{
	if (Phase == ETypeConstructPhase::Inner)
	{
		using TClass = ASafe;
		if (!Z_Registration_Info_UClass_ASafe.InnerSingleton)
		{
			GetPrivateStaticClassBody(
				TClass::StaticPackage(),
				TEXT("Safe"),
				Z_Registration_Info_UClass_ASafe.InnerSingleton,
				nullptr,
				DataSizeOf<TClass>(),
				alignof(TClass),
		...
		return Z_Registration_Info_UClass_ASafe.InnerSingleton;
	}
	if (!Z_Registration_Info_UClass_ASafe.OuterSingleton)
	{
		UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_ASafe.OuterSingleton, UHT_STATICS::ClassParams);
	}
	return Z_Registration_Info_UClass_ASafe.OuterSingleton;
}
#undef UHT_STATICS
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, ASafe);
ASafe::~ASafe() {}
// ********** End Class ASafe **********************************************************************
...
#error UHT_STATICS already defined
#endif
#define UHT_STATICS Z_CompiledInDeferFile_FID_mmarasigan2_Documents_Unreal_Projects_Lecture_5882_Lecture8552_Source_Lecture8552_Public_Interactable_Safe_h__Script_Lecture8552_Statics
struct UHT_STATICS
{
